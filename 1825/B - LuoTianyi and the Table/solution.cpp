...
int main(){
    ...
    TESTCASE{
        ...
        readvector(v,n*m);
        SORT(v);
        vector<ll> case1={v[v.size()-1]-v[0],v[v.size()-2]-v[0]};
        vector<ll> case2={v[v.size()-1]-v[0],v[v.size()-1]-v[1]};
        ll c1 = (b-1)*case1[1]+(a*b-b)*case1[0];
        ll c2 = (b-1)*case2[1]+(a*b-b)*case2[0];
        cout << max(c1,c2)<<"
";
    }
}

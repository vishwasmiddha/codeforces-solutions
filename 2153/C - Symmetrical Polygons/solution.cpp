    ...
    TESTCASE{
        ...
        if(sides<3){
           ...
           // print("a");
            ...
            while(biggest*2>=perimeter && times==1){
                //print("b",biggest,perimeter,times);
                while(v.size()!=0 && v[v.size()-1]==biggest){
                    v.pop_back();
                    perimeter-=biggest;
                    sides--;
                }
               ...
               // printvec(pending);
                if(pending.size()!=0){
                    perimeter+=pending[pending.size()-1];
                    pending.pop_back();
                    sides++;
                }
                if(sides<3){
           ...
           // print(biggest,times,perimeter);
        }
        if(flag)cout << perimeter<<"
";
        else cout << "0
";
